...
# random try --- delete later...
  ...
  # end
  #compute = Fog::Compute.new(:provider => 'AWS', :aws_access_key_id => '', :aws_secret_access_key => '')
  #storage = Fog::Storage.new(:provider => 'AWS', :aws_access_key_id => '', :aws_secret_access_key => '')
end
